...
**Issue Types:**
- `feat` - New feature (e.g., new kpenv command)
- `bug` - Fix existing functionality
- `improve` - Enhance existing feature
- `docs` - Documentation updates
- `dist` - Distribution/packaging improvements (install scripts, packages)
...
- [ ] Format: `[Agent] 2026-02-02: Description`
- [ ] Commit changes
...
### Issue Types
```
Core types: feat, bug, improve
Specialized: docs, dist, test
```

**Common patterns:**
- New commands: `feat-{command-name}` (e.g., `feat-list-command`)
- Distribution: `dist-{package-type}` (e.g., `dist-homebrew`)
- Testing: `test-{feature}` (e.g., `test-env-parsing`)

### Branch Strategy
**Parent branch:** develop
**Issue branches:** issue/YYYYMMDD-type-slug
**Merge strategy:** merge (with --no-ff for feature visibility)
