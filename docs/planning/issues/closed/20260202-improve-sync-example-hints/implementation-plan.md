...
- [x] **Task 1.1:** Modify `parse_env_line()` to extract inline comments
...
- [x] **Task 1.2:** Write unit tests for inline comment parsing
  ...
  - Location: `tests/Unit/ParseEnvLineTest.php` and `test-parse-env-line.php`

### Phase 2: Display Hints in sync-example

- [x] **Task 2.1:** Track pending comments while parsing .env.example
...
- [x] **Task 3.1:** Add interactive backup prompt after sync
...
- [x] **Task 3.2:** Implement backup execution on confirmation
...
- [x] **Task 3.3:** Manual testing of backup prompt
...
- [x] **Task 4.1:** Run all existing tests
  - `test-parse-env-line.php` - 10/10 tests passed
  - Ensure no regressions

- [x] **Task 4.2:** Run linting
  - `php -l kpenv` - No syntax errors
  - All test files checked

- [x] **Task 4.3:** Manual integration testing
  ...
  - Test complete workflow end-to-end - ALL PASSED

- [x] **Task 4.4:** Update documentation if needed
  - No README changes needed
  - Behavior is intuitive and self-documenting

### Phase 5: Commit & Close

- [x] **Task 5.1:** Commit changes with clear message
- [x] **Task 5.2:** Update session-log.md
- [x] **Task 5.3:** Run QA workflow from .qa-workflow.md
- [x] **Task 5.4:** Merge to develop
- [x] **Task 5.5:** Move issue to closed/
- [x] **Task 5.6:** Update global implementation-plan.md
